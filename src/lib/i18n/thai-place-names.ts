// English labels from the backend Thailand province and district seed data.
export const THAI_PLACE_NAMES: Readonly<Record<string, string>> = {
  ...
  บางกะปิ: "Bang Kapi",
  ปทุมวัน: "Pathum Wan",
  ป้อมปราบศัตรูพ่าย: "Pom Prap Sattruphai",
  ...
  มวกเหล็ก: "Muak Lek",
  วังม่วง: "Wang Muang",
  เฉลิมพระเกียรติ: "Chaloem Phra Kiet",
  ...
  แม่ออน: "Mae On",
  ดอยหล่อ: "Doi Lo",
  กัลยาณิวัฒนา: "Kanlayaniwatthana",
  ...
  เมืองสุพรรณบุรี: "Mueang Saphan Buri",
